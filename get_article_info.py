...
print('4', len(df_article_info_subtype))
...
print('5', len(df_article_info_subtype_name))
# 抓到分類的命名
...
print('6', len(df_article_info_all_type))
...
df_article_info_all_type.rename(
        columns={'UUID_x': 'article_id', 'TITLE': 'title', 'AUTHOR':'author', 'PUBLISH_DATE':'publish_date', 'URL_ID':'url', 'NAME_x':'subtype', 'NAME_y':'type'},
        inplace=True)
...
print(df_article_info_all_type[pd.isnull(df_article_info_all_type['type'])]['article_id'].unique())
